...
import cn.xiaolongonly.mpchartsample.chart.item.PieChartItem;
 ...
 */
public class PieChartActivity extends BaseTitleActivity {
    ...
    protected void initView() {
        ...
        PieChartItem lineChartItem = new PieChartItem.Builder(this)
