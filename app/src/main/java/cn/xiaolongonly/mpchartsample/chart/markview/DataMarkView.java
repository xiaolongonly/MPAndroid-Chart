package cn.xiaolongonly.mpchartsample.chart.markview;
...
public class DataMarkView extends MarkerView {
     ...
     */
    public DataMarkView(Context context, int layoutResource, IDataValueFormat iDataValueFormat) {
        super(context, layoutResource);
    }

    public DataMarkView(Context context, IDataValueFormat iDataValueFormat) {
        this(context, R.layout.layout_markview,iDataValueFormat);
